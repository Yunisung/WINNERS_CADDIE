...
import com.mtouch.ksnet.dpt.ErrorActivity;
import com.mtouch.ksnet.dpt.MainApplication;
import com.mtouch.ksnet.dpt.action.imp.BlueToothCompleteListener;
import com.mtouch.ksnet.dpt.action.imp.DefineFuction;
import com.mtouch.ksnet.dpt.action.obj.receiveObj;
import com.mtouch.ksnet.dpt.action.obj.responseObj;
import com.mtouch.ksnet.dpt.action.process.ksnetmodule.EncMSRManager;
import com.mtouch.ksnet.dpt.action.process.ksnetmodule.obj.AdminInfo;
import com.mtouch.ksnet.dpt.action.process.searchdevice.SearchBluetTooth;
import com.mtouch.ksnet.dpt.action.process.util.KsnetParsingByte;
import com.mtouch.ksnet.dpt.action.process.util.KsnetUtils;
import com.mtouch.ksnet.dpt.action.process.util.LOG;
import com.mtouch.ksnet.dpt.action.process.view.PayCreditSign;
...
import com.mtouch.ksnet.dpt.ks03.pay.CompleteCheckReceiver;
...
import static com.mtouch.ksnet.dpt.action.process.util.KsnetParsingByte.IDX_DATA;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.ACTIVITY_KSNET_READER_CONNECT;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.ACTIVITY_KSNET_READER_CONNECTED;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.ACTIVITY_MENU_GET_SIGN;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_ACTION_DATA_AVAILABLE;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_ACTION_GATT_CONNECTED;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_ACTION_GATT_DISCONNECTED;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_ACTION_GATT_SERVICES_DISCOVERED;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_BAT;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_COMPLETE;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_C0;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_C2;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_C3;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_C4;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_C5;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_C6;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_D0;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_D2;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_D3;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_D4;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_D5;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_DPT_D6;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_ICCARD_APPROVE_COMPLETE;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_ICCARD_CANCEL_APPROVE_COMPLETE;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_KSNET_READER_SEARCH;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_RETURN_NOK_ACTIVITY;
import static com.mtouch.ksnet.dpt.action.process.values.menuStatus.MESSAGE_RETURN_OK_ACTIVITY;
