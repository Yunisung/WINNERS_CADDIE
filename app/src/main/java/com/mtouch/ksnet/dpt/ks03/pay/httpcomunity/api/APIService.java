package com.mtouch.ksnet.dpt.ks03.pay.httpcomunity.api;
...
public interface APIService {
    ...
    @Headers("Content-Type: application/json")
    @POST("/v0/trx/crule")
    Call<ResponseBody> getCheckCancelApprove(@Header("Authorization") String token,
                                             @Body Request body
    );
    ...
    @Multipart
//    @Headers({"Content-Type: multipart/form-data","Accept: application/json","Accept-Language: ko_KR"})
    @POST("/sms/v3/file")
    Call<ResponseBody> uploadReceipt(@Header("Authorization") String token,
                                     @PartMap Map<String, RequestBody> params
//                                     @Part("file\"; filename=\"receipt") RequestBody file
