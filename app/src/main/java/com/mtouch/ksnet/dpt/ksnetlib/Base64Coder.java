...
class Base64Coder {
    ...
    static String encodeLines(byte[] bArr) {
        return encodeLines(bArr, 0, bArr.length, 76, systemLineSeparator);
    }

    static String encodeLines(byte[] bArr, int i, int i2, int i3, String str) {
        int i4 = (i3 * 3) / 4;
        if (i4 > 0) {
    ...
    static char[] encode(byte[] bArr) {
        return encode(bArr, 0, bArr.length);
    }

    static char[] encode(byte[] bArr, int i) {
        return encode(bArr, 0, i);
    }

    static char[] encode(byte[] bArr, int i, int i2) {
        int i3;
        byte b;
        int i4;
        byte b2;
    ...
    static byte[] decodeLines(String str) {
    ...
    static byte[] decode(char[] cArr, int i, int i2) {
        int i3;
        char c;
        if (i2 % 4 == 0) {
