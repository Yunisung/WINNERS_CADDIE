...
import com.mtouch.caddie.databinding.ActivitySmsBinding;
...
//        setContentView(R.layout.activity_sms);
    ...
    private void initView() {
        ...
        binding.sendSMSButton.setOnClickListener(v->{
            ...
            new MtouchDialog(this, positiveView -> {
                ...
                showLoading();
                caddieAPIService.sendSMS(param).enqueue(new Callback<com.mtouch.caddie.network.model.Response>() {
                    @Override
        ...
        binding.authSMSButton.setOnClickListener(v->{
            ...
            showLoading();
            caddieAPIService.sendAuthSMS(param).enqueue(new Callback<com.mtouch.caddie.network.model.Response>() {
                @Override
                public void onResponse(Call<com.mtouch.caddie.network.model.Response> call, retrofit2.Response<com.mtouch.caddie.network.model.Response> response) {
                    hideLoading();
                    if(response.isSuccessful()){
    ...
    private void signUpCheck(){
        ...
        showLoading();
        caddieAPIService.signUpCheck(param).enqueue(new Callback<com.mtouch.caddie.network.model.Response>() {
            @Override
            public void onResponse(Call<com.mtouch.caddie.network.model.Response> call, retrofit2.Response<com.mtouch.caddie.network.model.Response> response) {
                hideLoading();
                if(response.isSuccessful()){
