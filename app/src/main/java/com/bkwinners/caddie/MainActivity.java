...
import com.bkwinners.ksnet.dpt.design.HistoryActivity;
import com.bkwinners.ksnet.dpt.design.InfomationActivity;
import com.bkwinners.ksnet.dpt.design.PaymentCompleteActivity;
import com.bkwinners.ksnet.dpt.design.SettingActivity;
import com.bkwinners.ksnet.dpt.design.TotalActivity;
...
//            Toast.makeText(this, "mainButton", Toast.LENGTH_SHORT).show();
    ...
    private void caddieInit() {
        ...
        showLoading();
        caddieAPIService.check(map).enqueue(new Callback<com.bkwinners.caddie.network.model.Response>() {
            @Override
    ...
    private void init() {
        ...
        caddieAPIService.getStringToken(param).enqueue(new Callback<com.bkwinners.caddie.network.model.Response>() {
            ...
            public void onResponse(Call<com.bkwinners.caddie.network.model.Response> call, retrofit2.Response<com.bkwinners.caddie.network.model.Response> response) {
                ...
                if(response.isSuccessful()) {
                    ...
                    caddieAPIService.getSummary(params).enqueue(new Callback<com.bkwinners.caddie.network.model.Response>() {
                        @Override
                        public void onResponse(Call<com.bkwinners.caddie.network.model.Response> call, Response<com.bkwinners.caddie.network.model.Response> response) {
                            hideLoading();
                            HashMap<String, Object> responseData = response.body().getData();
