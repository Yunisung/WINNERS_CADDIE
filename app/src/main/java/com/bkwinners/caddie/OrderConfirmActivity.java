...
import com.bkwinners.caddie.databinding.ActivityOrderConfirmBinding;
    ...
    private void bindView() {
        ...
        binding.readerPayButton.setOnClickListener(v->{
            ...
            applyOrder(() -> {
                ...
                intent.putExtra(OrderDirectConfirmActivity.INTENT_KEY_INPUTDATA, "card");
                intent.putExtra(OrderDetail.INTENT_KEY_ORDER_DETAIL_LIST, orderDetailArrayList);
