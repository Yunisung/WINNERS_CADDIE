...
import com.bkwinners.caddie.databinding.ActivitySignupBinding;
...
//            param.put("phone",binding.phoneNumberEditText.getText().toString());
                ...
                showLoading();
                caddieAPIService.signup(param).enqueue(new Callback<com.bkwinners.caddie.network.model.Response>() {
                    @Override
