...
import com.bkwinners.caddie.databinding.ActivityLoginBinding;
...
//        setContentView(R.layout.activity_sms);
    ...
    private void initView() {
        ...
        binding.loginButton.setOnClickListener(v -> {
            ...
            showLoading();
            caddieAPIService.login(param).enqueue(new Callback<com.bkwinners.caddie.network.model.Response>() {
                @Override
