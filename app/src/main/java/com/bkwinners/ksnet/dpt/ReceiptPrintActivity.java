...
import com.bkwinners.caddie.databinding.ActivityReceiptPrintBinding;
...
//        String regDate = resp.data.get("regDate");
        ...
        caddieAPIService.sendReceiptSMS(param).enqueue(new Callback<com.bkwinners.caddie.network.model.Response>() {
