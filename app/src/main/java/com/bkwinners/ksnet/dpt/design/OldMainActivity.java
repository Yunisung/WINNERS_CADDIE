...
public class OldMainActivity extends DeviceCheckActivity {
...
//            Toast.makeText(this, "mainButton", Toast.LENGTH_SHORT).show();
            ...
            if (SharedPreferenceUtil.getData(this, "appDirect") == null || SharedPreferenceUtil.getData(this, "appDirect").equals("N")) {
                startActivityForResult(new Intent(this, CreditPaymentActivity.class), REQUEST_CODE_CREDIT_PAYMENT);
            } else if (SharedPreferenceUtil.getData(this, "appDirect").equals("Y")) {
                startActivityForResult(new Intent(this, DirectPaymentActivity.class), REQUEST_CODE_DIRECT_PAYMENT);
            }
    ...
    public void onClickMain(View view) {
        ...
        if (id == R.id.creditPaymentButton) {
            ...
            startActivityForResult(new Intent(this, CashPaymentActivity.class),REQUEST_CODE_CASH_PAYMENT);
    ...
    private void init() {
        ...
        Request request = new Request()
                ...
                .put("mchtId", SharedPreferenceUtil.getData(OldMainActivity.this, "mchtId"))
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    if (response.isSuccessful()) {
                        ...
                        //save
                        SharedPreferenceUtil.putData(OldMainActivity.this, "agencyEmail", responseobj.geKeyValye("agencyEmail"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "distEmail", responseobj.geKeyValye("distEmail"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "tmnId", responseobj.geKeyValye("tmnId"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "vat", responseobj.geKeyValye("vat"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "agencyTel", responseobj.geKeyValye("agencyTel"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "telNo", responseobj.geKeyValye("telNo"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "agencyName", responseobj.geKeyValye("agencyName"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "phoneNo", responseobj.geKeyValye("phoneNo"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "result", responseobj.geKeyValye("result"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "Authorization", responseobj.geKeyValye("Authorization"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "apiMaxInstall", responseobj.geKeyValye("apiMaxInstall"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "distTel", responseobj.geKeyValye("distTel"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "semiAuth", responseobj.geKeyValye("semiAuth"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "identity", responseobj.geKeyValye("identity"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "appDirect", responseobj.geKeyValye("appDirect"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "name", responseobj.geKeyValye("name"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "distName", responseobj.geKeyValye("distName"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "payKey", responseobj.geKeyValye("payKey"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "ceoName", responseobj.geKeyValye("ceoName"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "addr", responseobj.geKeyValye("addr"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "key", responseobj.geKeyValye("key"));

                        SharedPreferenceUtil.putData(OldMainActivity.this, "bankName", responseobj.geKeyValye("bankName"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "accntHolder", responseobj.geKeyValye("accntHolder"));
                        SharedPreferenceUtil.putData(OldMainActivity.this, "account", responseobj.geKeyValye("account"));
                        KSNETStatus.token = responseobj.geKeyValye("key");


                        menuMchtNameTextView.setText(SharedPreferenceUtil.getData(OldMainActivity.this, "name"));
                        menuTerminalIdTextView.setText(SharedPreferenceUtil.getData(OldMainActivity.this, "tmnId"));
                        mchtNameTextView.setText(SharedPreferenceUtil.getData(OldMainActivity.this, "name"));
                        terminalIdTextView.setText(SharedPreferenceUtil.getData(OldMainActivity.this, "tmnId"));

                        bankNameTextView.setText(SharedPreferenceUtil.getData(OldMainActivity.this, "bankName"));
                        accountTextView.setText(SharedPreferenceUtil.getData(OldMainActivity.this, "account"));
                        accountHolderTextView.setText(SharedPreferenceUtil.getData(OldMainActivity.this, "accntHolder"));
                         ...
                         * }
                         */
                        ApiUtils.getAPIService().getSummary(SharedPreferenceUtil.getData(OldMainActivity.this, "key"), new Request()).enqueue(new Callback<ResponseBody>() {
                            @Override
                            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                                try {
                                    if (response.isSuccessful()) {
                                        ...
                                        new MtouchDialog(OldMainActivity.this).setTitleText("알림").setContentText(resultMsg).show();
                                    }
...
//                    json.put("secondKey", data.getStringExtra("dptId"));
            ...
            com.bkwinners.ksnet.dpt.ks03.obj.Request rs = new com.bkwinners.ksnet.dpt.ks03.obj.Request();   //
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (Message2.indexOf("OK") >= 0) {   // 성공입니다
                        ...
                        if (mhashApprove.get("Classification").equals("HK")) {
                            //<<<<<<<<<<<<<<<<<<---------------------------------- 현금영수증
                            prnSendData(" 현금영수증",
                                    ksnetresp.PrnTempleteData(OldMainActivity.this, 0,
...
//                        APPROVE_RESULT_INFO(ksnetresp.toJsonString());
                        Log.d("tag", "==================ksnetresp.toJsonString()====================" + ksnetresp.toJsonString());
                         ...
                         sendMessage(NETWORK_SERVER_SEND, rs.toJsonString());  // 이곳에서 네트워크를 전송합니다
                        prnSendData(" 카드승인취소",
                                ksnetresp.PrnTempleteData(OldMainActivity.this, 1,
                                        ksnetresp.getString("vat")));
