...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(MtouchPayKsnet.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(MtouchPayKsnet.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(MtouchPayKsnet.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(MtouchPayKsnet.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MtouchPayKsnet.TOAST, "프린터에 연결할 수 없습니다");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(MtouchPayKsnet.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MtouchPayKsnet.TOAST, "프린터와 연결이 해지되었습니다");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
            ...
            while (true) {
                try {
                    ...
                    if(bytes>0)
                    {
                        ...
                        mHandler.obtainMessage(MtouchPayKsnet.MESSAGE_READ, bytes, -1, buffer)
                                .sendToTarget();
                    }
                    else
                    {
        ...
        public void write(byte[] buffer) {
            try {
               ...
               /* if (buffer.length > 3000) //
                ...
                mHandler.obtainMessage(MtouchPayKsnet.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
